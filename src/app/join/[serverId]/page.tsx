        ...
        <div className="border-6 border-black shadow-[8px_8px_0px_0px_#000000] rounded-3xl p-8 max-w-md backdrop-blur-sm bg-white/95">
          <div className="flex flex-col gap-y-6 items-center justify-center">
            <div className="flex flex-col gap-y-2 items-center justify-center text-center">
              ...
              <p className="text-sm font-mono text-gray-700">Enter the server code to join</p>
            </div>
            ...
            <VerificationInput
              ...
              length={6}
              classNames={{
                container: cn("flex gap-x-3", isPending && "opacity-50 cursor-not-allowed"),
                character:
                ...
                characterSelected: "bg-[#5170ff] text-white border-[#5170ff] shadow-[4px_4px_0px_0px_#5170ff]",
                characterFilled: "bg-[#7ed957] text-black border-[#7ed957] shadow-[4px_4px_0px_0px_#7ed957]",
              }}
              autoFocus
            />
          </div>
