      ...
      <motion.div
        ...
        <motion.div
          ...
          <div className="bg-white border-8 border-black p-8 mx-auto w-fit shadow-[8px_8px_0px_0px_#000000] rounded-3xl">
            ...
            <h1 className="text-6xl font-mono font-black text-black tracking-tighter">
              404
            </h1>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          <h2 className="text-xl font-mono font-bold text-black mb-2 uppercase tracking-wide">
            Page Not Found
          </h2>
