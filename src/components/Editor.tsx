...
const Editor = ({
  ...
  const renderTypingIndicator = () => {
    ...
    return (
      <motion.div
        className="px-4 py-2 mb-2 bg-white border-2 border-black rounded-lg shadow-[2px_2px_0px_0px_#000000]"
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mono font-bold text-gray-600 uppercase tracking-wide">{typingText}</span>
        </div>
      </motion.div>
    )
  }
  ...
  return (
    <div className="flex flex-col">
      ...
      {variant === "create" && (
        <motion.div
          className={cn(
            "p-2 text-xs font-mono text-gray-600 flex justify-end transition-opacity duration-200",
