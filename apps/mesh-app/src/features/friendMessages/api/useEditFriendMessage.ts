...
export const useEditFriendMessage = () => {
  ...
  const edit = useMutation(api.friendMessages.updateFriendMessage);

  const editFriendMessage = useCallback(
    async (
      { friendMessageId, body }: RequestType,
